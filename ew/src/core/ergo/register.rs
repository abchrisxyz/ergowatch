...
pub fn render_register_value(base16_str: &str) -> RenderedRegister {
...
mod tests {
    ...
    fn render_register_sigmaprop() {
        let cst = "08cd0327e65711a59378c59359c3e1d0f7abe906479eccb76094e50fe79d743ccc15e6";
        let rr = render_register_value(&cst);
    ...
    fn render_register_avltree() {
        ...
        //
        let cst = "64aebde47e15b6bfb577265ea5a819f5779328085286d86e7e1089636641dae9b80007200108";
        let rr = render_register_value(&cst);
