...
const FIXED_RATE: NanoERG = 75000000000; // 75 ERG
const FIXED_RATE_PERIOD: i64 = 525600; // Blocks
const EPOCH_LENGTH: i64 = 64800; // Blocks
const INITIAL_TREASURY_REWARD: NanoERG = 7500000000; // 7.5 ERG
const ONE_EPOCH_REDUCTION: NanoERG = 3000000000; // 3 ERG

// EIP-27
const REEMISSION_ACTIVATION_HEIGHT: i64 = 777217;
const REEMISSION_START_HEIGHT: i64 = 2080800;
const BASIC_CHARGE_AMOUNT: NanoERG = 12000000000; // 12 ERG
const THREE_ERG: NanoERG = 3000000000; // 3 ERG

#[allow(dead_code)]
/// Coinbase emission at height
pub fn emission_at_height(height: Height) -> NanoERG {
    let h = height as i64;
    if h < 1 {
        0i64
...
pub fn miner_reward_at_height(height: Height) -> NanoERG {
    let h = height as i64;
    if h < 1 {
        0i64
    } else if h < REEMISSION_START_HEIGHT {
...
pub fn treasury_reward_at_height(h: i64) -> NanoERG {
    if h < 1 {
        0i64
...
fn pre_eip27_emission_at_height(h: i64) -> NanoERG {
...
/// Miner reward at given `height`
fn pre_eip27_miner_reward_at_height(h: i64) -> NanoERG {
...
fn reemission_at_height(h: i64) -> NanoERG {
