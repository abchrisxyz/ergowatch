...
pub mod address_ids {
    ...
    pub const EMISSION: AddressID = 1;
    ...
    pub const TREASURY: AddressID = 3;

    /// Fees contract
    ///
    /// 2iHkR7CWvD1R4j1yZg5bkeDRQavjAaVPeTDFGGLZduHyfWMuYpmhHocX8GJoaieTx78FntzJbCBVL6rf96ocJoZdmWBL2fci7NqWgAirppPQmZ7fN9V6z13Ay6brPriBKYqLp1bT2Fk4FkFLCfdPpe
    pub const FEES: AddressID = 240;
    ...
    pub const REEMISSION: AddressID = 596523;
    ...
    pub const PAY_TO_REEMISSION: AddressID = 599350;
