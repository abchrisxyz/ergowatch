...
@pytest.mark.parametrize("no_bootstrap", [False, True])
def test_first_block_unconstrained(genesis_unconstrained_env, no_bootstrap):
    """
    ...
    cp = run_watcher(cfg_path, no_bootstrap=no_bootstrap)
