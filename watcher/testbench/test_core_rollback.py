...
# Before we can test this, need to deal api/blocks/at returning more than 1 block.

# def test_rollback(core_rollback_env):
#     """
#     Test rollback removes data from all core tables
#     """
#     db_conn, cfg_path = core_rollback_env
