...
const CURRENT_REVISION_MINOR: i32 = 33;
...
fn apply_migration(client: &mut Client, migration_id: i32) -> anyhow::Result<()> {
    ...
    match migration_id {
        ...
        23 => mig_023::apply(&mut tx)?,
        24 => mig_024::apply(&mut tx)?,
        25 => mig_025::apply(&mut tx)?,
        26 => mig_026::apply(&mut tx)?,
        27 => mig_027::apply(&mut tx)?,
        28 => mig_028::apply(&mut tx)?,
        29 => mig_029::apply(&mut tx)?,
        30 => mig_030::apply(&mut tx)?,
        31 => mig_031::apply(&mut tx)?,
        32 => mig_032::apply(&mut tx)?,
        33 => mig_033::apply(&mut tx)?,
