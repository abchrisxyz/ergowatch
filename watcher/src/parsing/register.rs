...
pub(super) fn render_register_value(cst: &Constant) -> RenderedRegister {
    let val = Value::from(cst.v.clone());
...
mod tests {
    ...
    fn render_register_value_long() {
        let cst = constant_from_base16("05a4c3edd9998877");
    ...
    fn render_register_empty_coll_of_byte() {
        let cst = constant_from_base16("0e00");
        let rr = render_register_value(&cst);
        assert_eq!(rr.value_type, "Coll[SByte]");
        assert_eq!(rr.value, "");
    }
    ...
    fn render_register_coll_of_coll_byte() {
        let cst = constant_from_base16("");
        let rr = render_register_value(&cst);
    ...
    fn render_register_empty_coll_of_coll_byte() {
        let cst = constant_from_base16("1a00");
        let rr = render_register_value(&cst);
        assert_eq!(rr.value_type, "Coll[Coll[SByte]]");
        assert_eq!(rr.value, "[]");
    }
    ...
    fn render_register_coll_of_tuple_of_two_coll_byte() {
        let cst = constant_from_base16("0c3c0e0e01240008cd0302122c332fd4e3c901f045ac18f559dcecf8dc61f6f94fbb34d0c7c3aac71fb7333967556962486f616569774b5a53707967685a4536594d455a564a753977734b7a465332335778525671366e7a547663476f55");
        let rr = render_register_value(&cst);
    ...
    fn render_register_coll_of_tuple_of_coll_byte_and_coll_long() {
        let cst = constant_from_base16("0c3c0e1101240008cd0302122c332fd4e3c901f045ac18f559dcecf8dc61f6f94fbb34d0c7c3aac71fb703028084af5f00");
        let rr = render_register_value(&cst);
    ...
    fn render_register_tuple_of_coll_byte_and_coll_byte() {
        let cst = constant_from_base16("");
        let rr = render_register_value(&cst);
    ...
    fn render_register_coll_int() {
        let cst = constant_from_base16("100204a00b");
        let rr = render_register_value(&cst);
    ...
    fn render_register_coll_of_tuple_of_int_and_long() {
        let cst = constant_from_base16("0c400504b40180febe81027880d4d4ab015a80bfdf80013c80aaea55");
        let rr = render_register_value(&cst);
    ...
    fn render_register_coll_long() {
        let cst = constant_from_base16("1106640a8094ebdc0380a0b787e905f4ac46c203");
        let rr = render_register_value(&cst);
    ...
    fn render_register_coll_of_tuple_of_long_and_long() {
        let cst = constant_from_base16("0c5902c0ea9801c0ddc60190fa9801e0fcc601");
        let rr = render_register_value(&cst);
    ...
    fn render_register_coll_of_tuple_of_sigmaprop_and_long() {
        let cst = constant_from_base16("0c440502cd020ffd8b096232c6753219b6ecc03fa615a6202d1bcf5b4b6a7e91bda2d785181a10cd0255b72ffe27588f75a78b7d4dbabac70d7eaf58b0ad56ca314204ea37d025dbe00c");
        let rr = render_register_value(&cst);
    ...
    fn render_register_bigint() {
        let cst = constant_from_base16("061913aaf504e4bc1e62173f87a4378c37b49c8ccff196ce3f0ad2");
        let rr = render_register_value(&cst);
    ...
    fn render_register_boolean() {
        let cst = constant_from_base16("0101");
        let rr = render_register_value(&cst);
    ...
    fn render_register_int() {
        let rr = render_register_value(&constant_from_base16("0400"));
        assert_eq!(rr.value_type, "SInt");
        assert_eq!(rr.value, "0");

        let rr = render_register_value(&constant_from_base16("0401"));
        assert_eq!(rr.value_type, "SInt");
        assert_eq!(rr.value, "-1");

        let rr = render_register_value(&constant_from_base16("0480d92a"));
        assert_eq!(rr.value_type, "SInt");
    ...
    fn render_register_long() {
        let cst = constant_from_base16("05b2e0d204");
        let rr = render_register_value(&cst);
        assert_eq!(rr.value_type, "SLong");
    ...
    fn render_register_short() {
        let cst = constant_from_base16("0322");
        let rr = render_register_value(&cst);
    ...
    fn render_register_sigmaprop() {
        let cst = constant_from_base16(
            "08cd0327e65711a59378c59359c3e1d0f7abe906479eccb76094e50fe79d743ccc15e6",
        );
        let rr = render_register_value(&cst);
    ...
    fn render_register_cbox() {
        let cst = constant_from_base16("");
        let rr = render_register_value(&cst);
    ...
    fn render_register_unit() {
        // Invalid ByteCode
        let cst = constant_from_base16("62");
        let rr = render_register_value(&cst);
