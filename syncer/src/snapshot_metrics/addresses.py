...
METRIC_ID = "addresses"
SERIES_TABLE = "mtr.address_counts_by_minimal_balance"
SUMMARY_TABLE = "mtr.address_counts_by_minimal_balance_change_summary"
...
async def query(conn: pg.Connection, timestamp) -> Record:
    """
    Returns current P2PK address counts by minimal balance.
