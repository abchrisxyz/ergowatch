...
METRIC_ID = "tvl"
SERIES_TABLE = "mtr.top_contracts_supply"
SUMMARY_TABLE = "mtr.top_contracts_supply_change_summary"
...
async def query(conn: pg.Connection, timestamp: int, height: int) -> Record:
    """
    Return current supply held in top x P2S9H) addreses,
    excluding known CEX's (if any) and treasury.
